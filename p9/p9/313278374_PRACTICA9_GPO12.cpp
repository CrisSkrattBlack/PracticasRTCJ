...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Practica9", nullptr, nullptr);
	...
	Shader Anim1("Shaders/anim.vs", "Shaders/anim.frag");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		model = glm::mat4(1);
		glUniform1f(glGetUniformLocation(Anim1.Program, "time"), tiempo1);
		//model = glm::translate(model, glm::vec3(0.0f, 0.1f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		//Box.Draw(Anim);
		//Piso.Draw(Anim);
